...
#include "me_longluo_mididriver_MidiDriver.h"
#include "midi.h"
...
jboolean
Java_me_longluo_mididriver_MidiDriver_init(JNIEnv *env,
                                                  jobject obj)
{
    return midi_init();
}
...
// midi config
jintArray
Java_me_longluo_mididriver_MidiDriver_config(JNIEnv *env,
                                                    jobject obj)
{
    jboolean isCopy;
...
jboolean
Java_me_longluo_mididriver_MidiDriver_write(JNIEnv *env,
                                                   jobject obj,
...
jboolean
Java_me_longluo_mididriver_MidiDriver_setVolume(JNIEnv *env,
                                                       jobject obj,
                                                       jint volume)
{
...
jboolean
Java_me_longluo_mididriver_MidiDriver_setReverb(JNIEnv *env,
                                                       jobject obj,
                                                       jint preset)
{
...
jboolean
Java_me_longluo_mididriver_MidiDriver_shutdown(JNIEnv *env,
                                                      jobject obj)
{
